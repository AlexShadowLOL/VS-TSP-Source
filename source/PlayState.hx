...
class PlayState extends MusicBeatState
{
	...
	override public function update(elapsed:Float)
	{
		...
		if(ratingString == '?') {
			scoreTxt.text = 'Total Score: ' + songScore + ' | Missed Notes: ' + songMisses + ' | Rank: ' + ratingString;
		} else {
			scoreTxt.text = 'Total Score: ' + songScore + ' | Missed Notes: ' + songMisses + ' | Rank: ' + ratingString + ' (' + Math.floor(ratingPercent * 100) + '%)';
		}
